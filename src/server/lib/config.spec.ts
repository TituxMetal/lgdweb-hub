...
describe('loadConfig', () => {
  it('defaults to port 3000, host 0.0.0.0 and development when env is empty', () => {
  ...
  it('falls back to 3000 on invalid PORT', () => {
